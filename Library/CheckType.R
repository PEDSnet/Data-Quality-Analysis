...
applyCheck <- function(theObject, table_list, field_list, con, metadata, table_df)
{
  #print("Calling the base applyCheck function")
  UseMethod("applyCheck",theObject)
}

applyCheck.default <- function(theObject, table_list, field_list, con, metadata, table_df)
{
  return(theObject)
}
