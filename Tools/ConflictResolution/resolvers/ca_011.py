...
# report,
#  (iii) threshold_l, and threshold_u are the thresholds corresponding to the check type CA-011
...
def resolve(log_issue, secondary_issue, threshold_l, threshold_u):
    ...
    # mutate the old issue in the secondary report with no changes
    mutated_issue = secondary_issue.copy()
    ## copy the latest finding
