...
df_care_site <- retrieve_dataframe_OHDSI(con, config,table_name)
...
fileContent<-c(fileContent,paste("The total number of",field_name,"is: ", describeIdentifier(df_care_site, field_name),"\n"))
...
fileContent<-c(fileContent,reportMissingCount(df_care_site,table_name,field_name,big_data_flag))
describeOrdinalField(df_care_site, table_name,field_name,big_data_flag)
